...
async function processQuery() {
    ...
    let sent5 = `The time this story takes place in is ${field5}.`;
    let sent6 = `The authority that governs the world where the story takes place in is ${field6}.`
    
    let finalQuery = `${sent0} ${sent1} ${sent2} ${sent3} ${sent4} ${sent5} ${sent6}`
